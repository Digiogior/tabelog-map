...
PROMPT = (
  ...
  "Extract only explicitly visible menu item names and return them as a JSON array. "
  "Each item should have only a name field containing the Japanese text as-is. "
